...
def load_train():
    """ Loads training data.
    """
    with open('hw2_code/q3/data/mnist_train.npz', 'rb') as f:
        train_set = np.load(f)
...
def load_train_small():
    ...
    """
    with open('hw2_code/q3/data/mnist_train_small.npz', 'rb') as f:
...
def load_valid():
    ...
    """
    with open('hw2_code/q3/data/mnist_valid.npz', 'rb') as f:
        valid_set = np.load(f)
...
def load_test():
    """ Loads test data.
    """
    with open('hw2_code/q3/data/mnist_test.npz', 'rb') as f:
        test_set = np.load(f)
